						...
						<div className="flex w-full max-w-[879px] flex-1 flex-col max-md:mt-10 md:pr-[200px]">
							...
							<div className="my-10 border-b border-t border-lightGrey py-10">
								...
								<p className="text-[17px] leading-[27px] tracking-[0.02em]">
									...
									klienci z nietypowych branż czy niestandardowe zlecenia? Uwielbiamy takie
									wyzwania. Otwartość to dla nas codzienność – to dzięki luźnej atmosferze tworzymy
									projekty, które żyją, ewoluują i odpowiadają na potrzeby klienta.
								</p>
							</div>
							<div>
								<div className="mb-5 flex items-center space-x-5">
								...
								<p className="text-[17px] leading-[27px] tracking-[0.02em]">
									Rozumiemy, że Twój projekt to coś więcej niż tylko zadanie – to Twój pomysł, wizja
									a często także kawałek serca. Dlatego zawsze staramy się znaleźć czas, nawet gdy
									dzień wydaje się za krótki. Utożsamiamy się z Twoimi celami, bo wiemy, że sukces
