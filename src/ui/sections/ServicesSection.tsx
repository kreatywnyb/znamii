...
const ServicesSection: React.FC = () => {
  ...
  const { ref: taglineRef, isInView: taglineInView } = useInView({ threshold: 0.3, triggerOnce: true });
        ...
        <div className="flex flex-col justify-between max-md:space-y-14 md:flex-row">
          <div className="">
            ...
            <ul className="space-y-3 text-xs font-normal uppercase text-lightGrey">
              <ServiceMenuItem href={`${links.services.main}${links.services.video}#logo`}>
                Logo
              </ServiceMenuItem>
              <ServiceMenuItem>identyfikacje wizualne</ServiceMenuItem>
              <ServiceMenuItem>Strony internetowe</ServiceMenuItem>
              <ServiceMenuItem>Naming</ServiceMenuItem>
              <ServiceMenuItem>projekty do druku</ServiceMenuItem>
