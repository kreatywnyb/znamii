...
const PortfolioSection = () => {
	return (
		<section className="container relative z-10 -mt-28 bg-white px-16 py-16">
			<h2 className="text-medium mb-4 text-left text-4xl text-[40px] font-bold text-basicDark mt-8">
			...
			<div className="mt-12 grid w-full grid-cols-3 gap-4">
				{portfolioItems.map((item, index) => (
					<div
						key={index}
						className={`col-span-${item.cols} group relative flex h-[380px] items-center justify-center bg-cover bg-center text-2xl font-bold text-white`}
            ...
            <div className="flex justify-center py-16"> <CTAButton href="" variant="white">Zobacz wszystkie realizacje</CTAButton></div>
		</section>
	);
};
